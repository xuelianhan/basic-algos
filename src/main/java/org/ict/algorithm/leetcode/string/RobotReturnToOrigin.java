...
/**
 * here is a robot starting at the position (0, 0), the origin, on a 2D plane.
...
public class RobotReturnToOrigin {
    ...
    public static boolean judgeCircle(String moves) {
        ...
        Integer uCount = frequencies.get('U');
        Integer dCount = frequencies.get('D');
        Integer lCount = frequencies.get('L');
        Integer rCount = frequencies.get('R');
        //System.out.println("uCount" + uCount + ", dCount:" + dCount + ", lCount:" + lCount + ", rCount:" + rCount);
        // LR
        if (uCount == null && dCount == null && lCount != null && lCount.equals(rCount)) {
            return true;
        }
        // UD
        if (lCount == null && rCount == null && uCount != null && uCount.equals(dCount)) {
            return true;
        }
        //UDLR
        if (uCount != null && uCount.equals(dCount) && lCount != null && lCount.equals(rCount)) {
            return true;
        }
        return false;
    }
