 ...
 * and each node of the tree has a label which is a lower-case character given in the string labels (i.e. The node with the number i has the label labels[i]).
 *
...
public class NumberOfNodesInSubTreeWithSameLabel {
    ...
    public int[] countSubTreesV1(int n, int[][] edges, String labels) {
        return null;
    }
