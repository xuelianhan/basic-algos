 ...
 * Input : arr[] = {1, 20, 3}
 * Output : 20
 * @see <a href="https://www.geeksforgeeks.org/maximum-sum-such-that-no-two-elements-are-adjacent/"></a>
 * @author sniper
 * @date 2021/8/12 8:48 PM
 */
public class MaximumSumNoAdjacentItem {
