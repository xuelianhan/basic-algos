...
public class LongestNiceSubstring {
    ...
    public String longestNiceSubstringV5(String s) {
        return "";
    }

    public String longestNiceSubstringV4(String s) {
        return "";
    }

    public String longestNiceSubstringV3(String s) {
        return "";
    }

    public String longestNiceSubstringV2(String s) {
        return "";
    }

    public String longestNiceSubstringV1(String s) {
        return "";
    }
