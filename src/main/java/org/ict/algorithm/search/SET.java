...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    public void add(Key key) {
        if (key == null) {
            throw new IllegalArgumentException("called add method with a null key");
        }
        set.add(key);
    }
    ...
    public boolean contains(Key key) {
        if (key == null) {
            throw new IllegalArgumentException("called contains method with a null key");
        }
    ...
    public void delete(Key key) {
        if (key == null) {
            throw new IllegalArgumentException("called delete method with a null key");
        }
        set.remove(key);
    }
     ...
     * To iterate over all of the keys in a set named {@code set}, use
     * the foreach notation: {@code for (Key key : set)}.
     *
    ...
    public Key max() {
        if (isEmpty()) {
            throw new NoSuchElementException("called max method with empty set");
        }
        return set.last();
    }
    ...
    public Key min() {
        if (isEmpty()) {
            throw new NoSuchElementException("called min method with empty set");
        }
        return set.first();
    }
     ...
     *
     * @param key the key
     * @return the largest key in this set less than or equal to {@code key}
     * @throws IllegalArgumentException if {@code key} is {@code null}
     * @throws NoSuchElementException if there is no such key
     */
    public Key floor(Key key) {
        if (key == null) {
            throw new IllegalArgumentException("called floor method with a null key");
        }
        Key k = set.floor(key);
        if (k == null) {
    ...
    public SET<Key> union(SET<Key> that) {
       if (that == null) {
            throw new IllegalArgumentException("called union method with a null argument");
       }
