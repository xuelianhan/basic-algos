 ...
 * It supports searching for a given integer is in the set. It
 * accomplishes this by keeping the set of integers in a sorted
 * array and using binary search to find the given integer.
 * <p>
 * The <em>rank</em> and <em>contains</em> operations take
 * logarithmic time in the worst case.
 * <p>
 * For additional documentation, see 
 * <a href="http://algs4.cs.princeton.edu/12oop">Section 1.2</a> of <i>Algorithms, 4th Edition</i> 
...
public class StaticSETofInts {
    ...
    /**
     * Returns either the index of search key in the sorted array.
     * (if the key is in the set) or -1 (if the key is not in the set).
     * @param key the search key
     * @return the number of keys in this set less than the key (if 
