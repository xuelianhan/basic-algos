...
/**
 * $ javac org/ict/algorithm/graphs/Edge.java
 * $ java org/ict/algorithm/graphs/Edge
 * 12-34 5.67000
 *
 ...
 * edge and the weight. The natural order for this data type is
...
public class Edge implements Comparable<Edge> {
    ...
    /**
     * Returns either endpoint of this page.
     * 
     * @return either endpoint of this page
     */
    public int either() {
        return v;
    }
    ...
    /**
     * Returns the endpoint of this edge that if different from the given vertex.
     *
     ...
     * whether the weight of this is less than, equal to, or greater than
     * the argument edge
     */
    @Override
